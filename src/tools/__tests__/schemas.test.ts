...
describe('tool registry', () => {
  it('exports 103 tools (QUA-739 — pricebook margin-discipline composites: markup_drift/cost_drift/vendor_part_gaps; Supabase-backed pricebook search tools)', () => {
  ...
  it('toolsForRole("default") excludes st_call; admin includes it', () => {
    expect(toolsForRole('default').length).toBe(102);
    expect(toolsForRole('admin').length).toBe(103);
