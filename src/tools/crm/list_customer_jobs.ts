...
export const list_customer_jobs: ToolDef<Args> = {
  ...
  description: 'List jobs for a customer. Source: live ST (auto-falls-back to live if D1 stale >48h). Optional page/pageSize, max pageSize 200; ST default page size applies when omitted.',
  zodSchema: {
